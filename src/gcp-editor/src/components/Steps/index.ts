    ...
    return html`
      <div class="tw-flex tw-flex-col tw-gap-3">
        ...
        <div class="tw-flex tw-items-center">
          <div
            class="tw-flex tw-items-center tw-justify-center tw-rounded-full tw-border-[0.15rem] lg:tw-h-7 lg:tw-w-7 xl:tw-h-9 xl:tw-w-9 tw-border-primary ${
              this.activeStep > this.step.step ? "tw-bg-primary" : "tw-bg-[#ffffff]"
            }"
          >
            <span
              class="material-symbols-outlined ${
                this.activeStep > this.step.step ? "tw-text-[#ffffff]" : "tw-text-primary"
              }"
            >
              check
            </span>
          ...
          ${
            this.isLastStep
              ...
              : html`
                <div
                  class="tw-mx-4 tw-w-[6rem] tw-border-t-[3px] xl:tw-w-[9rem] 2xl:tw-w-[12rem] ${
                    this.activeStep > this.step.step ? "tw-border-primary" : "tw-border-dashed"
                  }"
                ></div>
              `
          }
