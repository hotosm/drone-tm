...
async def upload_file_to_s3(
    ...
    file_path = f"{settings.S3_PATH_PREFIX}/projects/{project_id}/{file_name}"
...
def get_project_info_from_s3(project_id: uuid.UUID, task_id: uuid.UUID):
    ...
    try:
        ...
        images_prefix = (
            f"{settings.S3_PATH_PREFIX}/projects/{project_id}/{task_id}/images/"
        )
        ...
        try:
            ...
            assets_path = (
                f"{settings.S3_PATH_PREFIX}/projects/{project_id}/{task_id}/assets.zip"
            )
