...
async def start_project_classification(
    ...
    disable_gimbal_deviation_rejection = bool(
        body and body.disable_gimbal_deviation_rejection
    )
    ...
    job = await redis.enqueue_job(
        ...
        disable_gimbal_deviation_rejection=disable_gimbal_deviation_rejection,
