...
const ShowInfo = ({ message, className, heading, wrapperClassName }: IShowInfo) => {
  return (
    <div
    ...
    >
      <div className="naxatw-flex naxatw-items-center naxatw-gap-1">
        ...
        <h6 className="naxatw-text-base naxatw-font-semibold naxatw-text-gray-600">{heading}</h6>
      </div>
      <div className={`naxatw-text-xs naxatw-text-gray-500 ${className}`}>{message}</div>
    </div>
  );
};
