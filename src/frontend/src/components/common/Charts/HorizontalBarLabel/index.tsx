...
export default function HorizontalBarLabel({
  ...
  return (
    <div className="bar naxatw-group naxatw-relative naxatw-h-8 naxatw-w-full">
      <div
        className="fill naxatw-h-full naxatw-rounded-r-lg naxatw-bg-blue-200 naxatw-bg-opacity-50 naxatw-transition-all naxatw-duration-500 naxatw-ease-in-out group-hover:naxatw-border"
        style={{ width: `${width}%` }}
      />
