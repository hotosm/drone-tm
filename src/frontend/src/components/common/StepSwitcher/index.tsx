 ...
 */
const StepSwitcher = ({ data, activeStep, onStepClick }: IStepSwitcherProps) => {
  return (
              ...
              <div className="naxatw-flex naxatw-w-full naxatw-items-center">
                <div className="naxatw-flex naxatw-w-full naxatw-flex-col">
                  <div className="naxatw-flex naxatw-items-end naxatw-gap-3">
                    ...
                    <p className="naxatw-text-lg naxatw-text-gray-500">{step.name}</p>
                  </div>
                    ...
                    >
                      {activeStep >= index && (
                        <Icon
                          name="check"
                          className={`${
                            activeStep > index ? "naxatw-text-white" : "naxatw-text-red"
