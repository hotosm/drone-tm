...
export const videoTutorialData: IVideoTutorialItems[] = [
  {
    ...
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Sign+Up+and+Log+In.mp4',
  ...
  },
  {
    id: 'Project+Creation',
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Project+Creation.mp4',
  ...
  },
  {
    ...
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Workflow+for+Drone+Operators.mp4',
  ...
  },
  {
    ...
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Flight+Plan+Loading+on+RC.mp4',
  ...
  },
  {
    ...
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Flight+Plan+Replacement+on+RC+By+App.mp4',
  ...
  },
  {
    ...
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Flight+Plan+Replacement+on+RC+By+Laptop.mp4',
  ...
  },
  {
    id: 'Image+Processing',
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Image+Processing.mp4',
...

  {
    ...
    videoUrl:
      'https://dronetm-prod.s3-accelerate.amazonaws.com/tutorials/Viewing+Final+Output.mp4',
