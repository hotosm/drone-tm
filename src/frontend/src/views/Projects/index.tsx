...
import { ProjectCard, ProjectsHeader, ProjectsMapSection } from "@Components/Projects";
import { useGetProjectCentroidQuery, useGetProjectsListQuery } from "@Api/projects";
      ...
      <div className="naxatw-grid naxatw-gap-2 naxatw-pb-10 md:naxatw-flex md:naxatw-h-[calc(100vh-11rem)] md:naxatw-pb-0">
        ...
        {showMap && (
          <div className="naxatw-h-[70vh] naxatw-w-full naxatw-py-2 naxatw-shadow-xl md:naxatw-h-full md:naxatw-w-1/2">
            {!isCentroidFetching ? (
              <ProjectsMapSection projectCentroidList={projectCentroids as Record<string, any>[]} />
            ) : (
